...
//        Integer[] binarySearchInput = {2, 5, 8, 12, 16, 23, 38, 56, 72, 91, 93};
//        int binarySearchResponse = (new BinarySearch()).search(binarySearchInput, 38);
//        System.out.println("Binary search response = " + binarySearchResponse);
